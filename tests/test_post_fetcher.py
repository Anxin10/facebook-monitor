...
class TestGraphClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = GraphClient(
            access_token="test_token", api_version="v26.0", logger=self.logger
        )
    ...
    def test_custom_api_version(self):
        """測試自訂 API version"""
        client = GraphClient(
            access_token="test", api_version="v25.0", logger=self.logger
        )
    ...
    def test_get_retry_after_date_header(self):
        ...
        mock_response.headers = {
            "Retry-After": future_time.strftime("%a, %d %b %Y %H:%M:%S GMT")
        }
        error = requests.HTTPError(response=mock_response)
...
class TestPostFetcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {
            ...
            "targets": [{"page_id": "test_page", "enabled": True}],
            "notifications": {
        ...
        def mock_get(path, params=None):
            ...
            if call_count[0] == 1:
                ...
                mock_response.json.return_value = {
                    ...
                    "paging": {"next": "next_url", "cursors": {"after": "cursor_1"}},
                }
            else:
                # 第二頁
                mock_response.json.return_value = {
